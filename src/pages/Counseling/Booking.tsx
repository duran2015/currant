...
export function Booking() {
  ...
  const [selectedMethod, setSelectedMethod] = useState<"text" | "voice">(
    "voice",
  );
  ...
  const handleConfirm = () => {
    ...
    const newOrder: BookingOrder = {
      ...
      type: selectedMethod,
      price:
        selectedMethod === "text" ? counselor.price * 0.7 : counselor.price, // text is a bit cheaper
      status: "pending",
    };
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            <button
              ...
              className={`py-3 px-4 rounded-2xl border-2 transition-all flex flex-col items-start ${
            ...
            >
              <span
                className={`font-bold text-[14px] mb-1 ${selectedMethod === "voice" ? "text-primary" : "text-gray-900"}`}
              >
                视频/语音咨询
              </span>
            ...
            >
              <span
                className={`font-bold text-[14px] mb-1 ${selectedMethod === "text" ? "text-primary" : "text-gray-900"}`}
              >
                文字沟通
              </span>
              <span className="text-[11px] text-gray-500">
